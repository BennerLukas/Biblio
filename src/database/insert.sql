...
('9780345524591', 'Moon Over Soho', 2, 'Urban Fantasy', DATE '2011-04-21', NULL , NULL, false, 1, 2),  -- Author 1
('9780525516019', 'A Land of Permanent Goodbyes', NULL, NULL, NULL, 'en', 18, false, 1, 1), -- Author 3
(NULL, 'Der Text des Lebens', NULL, NULL, NULL, 'de', 40, false, 2, 3); -- Author 2 
